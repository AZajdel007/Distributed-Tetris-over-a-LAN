...
class MainMenu:
    ...
    def main_menu(self):
        ...
        play_k_width_button = button.Button(50, 400, 200, 50, "Play K-Width", colors.color[8], colors.color[9], colors.color[0], start_solo_game_action)
        play_shifting_button = button.Button(50, 500, 200, 50, "Play Shifting", colors.color[8], colors.color[9], colors.color[0], start_solo_game_action)
